...
for train_index, test_index in kf.split(x):
 ...
 index = index + 1
print("BrainLink MIX average_acc:", numpy.mean(acc), "std_acc:", numpy.std(acc))
...
for train_index, test_index in kf.split(x_open):
 ...
 acc[index] = accuracy_score(test_y, y_pred)
 index = index + 1
print("BrainLink Open Eyes average_acc:", numpy.mean(acc), "std_acc:", numpy.std(acc))
...
for train_index, test_index in kf.split(x_close):
 ...
 acc[index] = accuracy_score(test_y, y_pred)
 index = index + 1
print("BrainLink Close Eyes average_acc:", numpy.mean(acc), "std_acc:", numpy.std(acc))
...
#print(test_X.shape)
 ...
 regr.fit(train_X, train_y)
 y_pred = regr.predict(test_X)
 acc2.append(accuracy_score(test_y, y_pred))
 #print(accuracy_score(test_y, y_pred))
 #acc[index] = accuracy_score(test_y, y_pred)
 #index = index + 1
print("BrainLink leave one out average_acc:", numpy.mean(acc2), "std_acc:", numpy.std(acc2))
sys.exit()
